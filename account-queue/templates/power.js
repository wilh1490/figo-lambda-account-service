...
export async function PowerTemplate(data, browser) {
  try {
    const { payment_ref, amount, date, status, user, misc } = data;
    ...
    console.error("Power template error", error);
  }
}
